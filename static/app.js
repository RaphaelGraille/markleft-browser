...
const ICON_EDIT = `<svg viewBox="0 0 16 16" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round" stroke-linecap="round"><path d="M11 2.3 13.7 5 5.2 13.5l-3.2.7.7-3.2z"/></svg>`;
const ICON_SAVE = `<svg viewBox="0 0 16 16" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round" stroke-linecap="round"><path d="M2.5 2.5h9l2 2v9h-11z"/><path d="M4.5 2.5v4h6v-4M4.5 13.5v-4h7v4"/></svg>`;
